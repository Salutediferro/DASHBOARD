...
export const coachNav: NavItem[] = [
  ...
  { label: "Nutrizione", href: "/dashboard/coach/nutrition", icon: Apple, group: G.nutrition },
...
export const patientNav: NavItem[] = [
  ...
  { label: "Nutrizione", href: "/dashboard/patient/nutrition", icon: Apple, mobile: true, group: G.nutrition },
